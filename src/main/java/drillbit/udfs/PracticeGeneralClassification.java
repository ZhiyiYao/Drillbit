...
public class PracticeGeneralClassification implements DrillSimpleFunc {
    ...
    public void eval() {
        if (learnerHolder == null) {
            ...
            try {
                learnerHolder.obj = (new FedGeneralClassificationLearner()).fromByteArray(learnerBytes);
        ...
        resultHolder.value = (int) ((FedGeneralClassificationLearner) learnerHolder.obj).predict(feature, "");
    }
}
