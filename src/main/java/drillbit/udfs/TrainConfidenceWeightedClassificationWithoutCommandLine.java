...
public class TrainConfidenceWeightedClassificationWithoutCommandLine implements DrillAggFunc {
    @Param
    ...
    @Override
    public void output() {
        byte[] modelBytes = ((drillbit.classification.ConfidenceWeightedClassificationLearner) learnerHolder.obj).output("");
