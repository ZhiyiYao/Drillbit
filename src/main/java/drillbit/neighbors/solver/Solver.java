...
public abstract class Solver {
    ...
    public abstract int solveIndex(int k, Distance metric, Weight weight, double[] vec);

    public abstract String solveLabel(int k, Distance metric, Weight weight, double[] vec);

    abstract ArrayList<Score> solveNeighbors(int k, Distance metric, Weight weight, double[] vec);
}
