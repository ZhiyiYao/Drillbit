...
public class TrainKNeighborsClassificationWithCommandLine implements DrillAggFunc {
    @Param
    ...
    @Override
    public void output() {
        byte[] modelBytes = ((drillbit.neighbors.KNeighborsClassificationLearner) learnerHolder.obj).output((String) optionsHolder.obj);
