...
public class GeneralClassificationWithCommandLine implements DrillAggFunc {
    @Param
    ...
    public void add() {
        ...
        ((drillbit.classification.GeneralClassificationLearner) learnerHolder.obj).add(feature, target, commandLine);
    }
